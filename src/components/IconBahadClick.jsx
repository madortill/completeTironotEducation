...
<path
 onClick={() => handleFlameClick("command")}
  style={{
    cursor: "pointer",
    opacity:
      selectedFlame && selectedFlame !== "command" ? 0.2 : 1
  }}
...
onClick={() => handleFlameClick("mission")}
  style={{
    cursor: "pointer",
    opacity:
      selectedFlame && selectedFlame !== "mission" ? 0.2 : 1
  }}
...
onClick={() => handleFlameClick("adam")}
  style={{
    cursor: "pointer",
    opacity:
      selectedFlame && selectedFlame !== "adam" ? 0.2 : 1
  }}
...
onClick={() => handleFlameClick("mamlachtiut")} 
  style={{
    cursor: "pointer",
    opacity:
      selectedFlame && selectedFlame !== "mamlachtiut" ? 0.2 : 1
  }}
d="M153.749 307.376C136.018 302.442 119.726 294.57 107.749 281.613C94.6658 267.459 90.5126 252.332 94.7108 234.151C96.2152 227.633 99.0505 222.095 103.544 216.822C103.808 218.806 103.808 220.904 103.737 222.905C103.197 238.359 106.476 250.427 118.318 261.945C124.973 268.414 132.938 270.537 138.712 277.744C145.739 286.511 150.483 297.025 153.749 307.376Z" fill="#0D5B9F"/>
<path d="M106.141 143.844L108.173 138L110.459 143.844L116.3 146.766L110.459 149.156L108.173 155L106.141 149.156L100.3 146.766L106.141 143.844Z" fill="#FFFFD7" stroke="#FFFFD7"/>
<path d="M99.681 159.125L101.205 155L102.919 159.125L107.3 161.188L102.919 162.875L101.205 167L99.681 162.875L95.3 161.188L99.681 159.125Z" fill="#FFFFD7" stroke="#FFFFD7"/>
<path d="M245.141 255.844L247.173 250L249.459 255.844L255.3 258.766L249.459 261.156L247.173 267L245.141 261.156L239.3 258.766L245.141 255.844Z" fill="#FFFFD7" stroke="#FFFFD7"/>
<path d="M238.681 271.125L240.205 267L241.919 271.125L246.3 273.188L241.919 274.875L240.205 279L238.681 274.875L234.3 273.188L238.681 271.125Z" fill="#FFFFD7" stroke="#FFFFD7"/>
<defs>
<filter id="filter0_f_165_37" x="4.57764e-05" y="32.7" width="306.6" height="359.6" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
<feFlood flood-opacity="0" result="BackgroundImageFix"/>
<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
<feGaussianBlur stdDeviation="37.65" result="effect1_foregroundBlur_165_37"/>
</filter>
</defs>
</svg>
